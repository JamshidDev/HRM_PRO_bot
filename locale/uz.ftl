...
sendPhoneNumber =📞 Telefon raqam yuborish
enterPassportPin = ✍️ Passport JSHSHIRingizni yozing
invalidPassportPin = ⚠️ Iltimos passport JSHSHIRingizni to'g'ri yozing
...
invalidService = ⚠️ Iltimos xizmatni tugma orqali tanlang!
terminalStatus =*Terminallar ro'yhati*

    🔹 \- Online
    🔸 \- Offline

totalTerminal = Terminallar soni: *{$n}*
currentPage = _Joriy sahifa: *{$n}*_
...
medMessageTitle =📑  *Tibbiy ko'rik ma'lumotlaringiz*
totalMed =_🗃 Barchasi: {$n}_
